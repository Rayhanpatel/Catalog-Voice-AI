...
- concierge NPC presence and interaction flow
...
- approach the concierge and press `E` to start a consultation
- ask by voice or type into the consultation panel
- answers remain grounded in the product catalog
- replies appear in text and play through premium cloud TTS
- recommendation cards stay attached to the answer that referenced them
...
- `E` near the concierge to open the consultation
...
src/
  ...
  features/
    ...
    npc/        # concierge interaction shell and consultation flow
